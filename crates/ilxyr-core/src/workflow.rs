...
pub fn submit_contribution(
    ...
    require_registered_nsrl_actor(workspace, &contribution.actor)?;
...
pub fn compile_experiment(workspace: &Workspace, spec: ExperimentSpec) -> Result<String> {
    ...
    require_registered_nsrl_actor(workspace, &spec.proposer)?;
    for model in &spec.models {
        require_registered_huggingface_weight(workspace, model)?;
        require_registered_nsrl_weight(workspace, model)?;
    }
...
pub fn submit_forecast(workspace: &Workspace, forecast: Forecast) -> Result<String> {
    ...
    require_registered_nsrl_actor(workspace, &forecast.forecaster)?;
...
pub fn commit_funding(workspace: &Workspace, commitment: FundingCommitment) -> Result<String> {
    ...
    require_registered_nsrl_actor(workspace, &commitment.funder)?;
