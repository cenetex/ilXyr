"""Read the frozen weight launch dependencies and prove EC2 dry-run permission."""
import argparse
import base64
import json
...
import subprocess
import time
from package_weight_cloud import inspect, encode
...
def lifecycle_rules(plan):
    s = plan['storage']
    return [{'ID': 'weight35-' + kind, 'Status': 'Enabled', 'Filter': {'Prefix': s[key]},
