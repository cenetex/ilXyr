"""Read the frozen FERAL launch dependencies and prove EC2 dry-run permission."""
import argparse
import base64
import json
...
import subprocess
import time
from package_feral_coverage_cloud import inspect, encode
...
def lifecycle_rules(plan):
    s = plan['storage']
    return [{'ID': 'feral-49-' + kind, 'Status': 'Enabled', 'Filter': {'Prefix': s[key]},
            ...
            {'ID': 'feral-49-markers-' + kind, 'Status': 'Enabled', 'Filter': {'Prefix': s[key]},
