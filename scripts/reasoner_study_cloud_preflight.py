...
import subprocess
import time
from package_reasoner_study_cloud import inspect, encode
...
def lifecycle_rules(plan):
    s = plan['storage']
    return [{'ID': 'reasoner-46-' + kind, 'Status': 'Enabled', 'Filter': {'Prefix': s[key]},
            ...
            {'ID': 'reasoner-46-markers-' + kind, 'Status': 'Enabled', 'Filter': {'Prefix': s[key]},
