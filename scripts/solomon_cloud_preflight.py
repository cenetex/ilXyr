"""Read the frozen solomon launch dependencies and prove EC2 dry-run permission."""
import argparse
import base64
import json
...
import subprocess
import time
from package_solomon_cloud import inspect, encode
...
def lifecycle_rules(plan):
    s = plan['storage']
    return [{'ID': 'solomon38-' + kind, 'Status': 'Enabled', 'Filter': {'Prefix': s[key]},
            ...
            {'ID': 'solomon38-markers-' + kind, 'Status': 'Enabled', 'Filter': {'Prefix': s[key]},
